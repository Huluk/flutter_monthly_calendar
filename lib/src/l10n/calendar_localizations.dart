...
import 'calendar_localizations_de.dart';
import 'calendar_localizations_en.dart';
import 'calendar_localizations_es.dart';
import 'calendar_localizations_fr.dart';
import 'calendar_localizations_nl.dart';
import 'calendar_localizations_pt.dart';
...
abstract class CalendarLocalizations {
  ...
  /// Label for the button that navigates to the current month
  ///
  /// In en, this message translates to:
  /// **'Today'**
  String get todayButton;

  /// Formatted ISO week number label
  ///
  /// In en, this message translates to:
  /// **'W{week}'**
  String weekNumber(int week);

  /// Full week number label for accessibility
  ///
  /// In en, this message translates to:
  /// **'Week {week}'**
...
CalendarLocalizations lookupCalendarLocalizations(Locale locale) {
  ...
  switch (locale.languageCode) {
    case 'de':
      return CalendarLocalizationsDe();
    case 'en':
    ...
    case 'nl':
      return CalendarLocalizationsNl();
    case 'pt':
      return CalendarLocalizationsPt();
  }
